...
import com.project.segicr.databinding.ActivityFacultyBinding;
...
public class FacultyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        root = FirebaseDatabase.getInstance().getReference(Utils.FACULTY_NODE);
        root.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    if (snapshot.getChildrenCount()>0){
                        ...
                        adapter=new ArrayAdapter<String>(FacultyActivity.this,android.R.layout.simple_list_item_1,listItems);
            ...
            binding.list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    alertDialog(FacultyActivity.this, txt);
                }
            });
        ...
        binding.btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                showDialog(FacultyActivity.this);
            }
        });
